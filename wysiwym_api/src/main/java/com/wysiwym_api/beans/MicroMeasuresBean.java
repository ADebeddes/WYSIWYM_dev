...
public enum MicroMeasuresBean {
    ...
    public static String getPath(MicroMeasuresBean measure){
    ...
    public static String getName(MicroMeasuresBean measure){
        return measure.toString();
    }
    
    public static String getDescription(MicroMeasuresBean measure){
        if(measure == levenshtein){
